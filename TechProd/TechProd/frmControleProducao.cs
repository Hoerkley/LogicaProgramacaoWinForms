    ...
    public partial class frmControleProducao : Form
    {
        ...
        private void txtValorReceber_TextChanged(object sender, EventArgs e)
        {
            if(!string.IsNullOrEmpty(txtInconsistencia.Text))
            {
               ...
               txtSalarioBase.Text =salarioBase.ToString("N2");
        ...
        private double CalcularSalarioRecber()
        {
            DateTime final  = DateTime.Now;
            DateTime inicio = Convert.ToDateTime(txtDataEntrega.Text);
            TimeSpan diaAtrazo = final - inicio;
            int intervalo = diaAtrazo.Days;
